 ...
 */
function calculateElliottWave(data, sensitivity = 0.02) {
...
export class ElliottWave extends BaseIndicator {
    ...
    validateInput(data, config) {
        ...
        const sensitivity = config?.['sensitivity'] || 0.02;
    ...
    calculate(data, config) {
        ...
        const sensitivity = config?.['sensitivity'] || 0.02;
        const values = calculateElliottWave(data, sensitivity);
        return {
            values,
            metadata: {
 ...
 * @returns Elliott Wave pattern values
 */
export function elliottWave(data, sensitivity = 0.02) {
