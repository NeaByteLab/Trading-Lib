 ...
 */
function calculatePressure(high, low, close) {
 ...
 */
function calculateUltimateOscillator(data, period1 = 7, period2 = 14, period3 = 28, weight1 = 4, weight2 = 2, weight3 = 1) {
...
export class UltimateOscillator extends BaseIndicator {
    ...
    validateInput(data, config) {
        ...
        const period1 = config?.['period1'] || 7;
        const period2 = config?.['period2'] || 14;
        const period3 = config?.['period3'] || 28;
        const weight1 = config?.['weight1'] || 4;
        const weight2 = config?.['weight2'] || 2;
        const weight3 = config?.['weight3'] || 1;
    ...
    calculate(data, config) {
        ...
        const weight2 = config?.['weight2'] || 2;
        const weight3 = config?.['weight3'] || 1;
        const values = calculateUltimateOscillator(data, period1, period2, period3, weight1, weight2, weight3);
        return {
            values,
            metadata: {
 ...
 * @returns Array of Ultimate Oscillator values
 */
export function ultimateOscillator(data, period1 = 7, period2 = 14, period3 = 28, weight1 = 4, weight2 = 2, weight3 = 1) {
