...
export class Stochastic extends BaseIndicator {
    ...
    calculate(data, config) {
        ...
        const kLength = pineLength(config?.['kLength'] || DEFAULT_LENGTHS.K, DEFAULT_LENGTHS.K);
        const dLength = pineLength(config?.['dLength'] || DEFAULT_LENGTHS.D, DEFAULT_LENGTHS.D);
