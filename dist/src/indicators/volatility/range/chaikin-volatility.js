 ...
 */
function calculateChaikinVolatility(data, length = 10) {
 ...
 * @throws {Error} If data is invalid or missing required fields
 */
export function chaikinVolatility(data, length, source) {
    const config = { length: length || 10, source: source || 'close' };
