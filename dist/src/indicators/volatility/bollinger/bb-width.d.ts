 ...
 * ```
 */
export declare function bollingerBandWidth(data: number[], length?: number, multiplier?: number): number[];
/**
 * Bollinger Band Width Class Implementation
 */
export declare class BollingerBandWidthIndicator extends VolatilityIndicator {
    protected calculateVolatility(data: number[], length: number, multiplier: number): number[];
}
//# sourceMappingURL=bb-width.d.ts.map