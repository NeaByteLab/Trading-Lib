 ...
 */
function calculateFeatures(data, currentIndex, lookback) {
 ...
 */
function calculateBayesianProbabilityWrapper(features) {
 ...
 * ```
 */
export function bayesianGLM(data, lookback = 20, threshold = 0.5) {
...
export class BayesianGLMIndicator {
    lookback;
    threshold;
    constructor(lookback = 20, threshold = 0.5) {
