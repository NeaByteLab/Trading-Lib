 ...
 */
export function calculateDirectionalMovement(data, i, prevHigh, prevLow) {
 ...
 */
export function calculateSmoothedDirectionalValues(tr, plusDM, minusDM, i, length, plusDIValues, minusDIValues, trValues) {
 ...
 */
export function calculateBalanceOfPower(data) {
 ...
 */
export function findDaysSinceExtremes(high, low, currentIndex, length) {
