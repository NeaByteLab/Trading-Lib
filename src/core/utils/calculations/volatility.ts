 ...
 * ```
 */
export function calculateTrueRange(high: number[], low: number[], close: number[]): number[] {
 ...
 * ```
 */
export function calculateBands(data: number[], length: number, multiplier: number): {
  upper: number[]
  middle: number[]
  lower: number[]
} {
 ...
 * ```
 */
export function calculateBollingerBandWidth(data: number[], length: number, multiplier: number): number[] {
 ...
 * @throws {Error} If data is invalid or missing required fields
 */
export function calculateDonchianChannel(high: number[], low: number[], length: number): {
  upper: number[]
  middle: number[]
  lower: number[]
} {
 ...
 * @throws {Error} If data is invalid or missing required fields
 */
export function calculatePriceChannels(high: number[], low: number[], length: number): {
  upper: number[]
  lower: number[]
} {
  if (!high || high.length === 0 || !low || low.length === 0) {
 ...
 * @throws {Error} If data is invalid or missing required fields
 */
export function calculateKeltnerChannel(close: number[], atrValues: number[], multiplier: number): {
  upper: number[]
  middle: number[]
  lower: number[]
} {
