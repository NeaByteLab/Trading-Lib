 ...
 */
export function calculateTRIX(data: number[], length: number = 18): number[] {
  if (data.length === 0) {
    return []
  }
 ...
 */
export function calculateTSI(data: number[], firstLength: number = 25, secondLength: number = 13): number[] {
  if (data.length === 0) {
    return []
  }
 ...
 */
export function calculateTwiggsMomentum(data: number[], length: number = 20, lookback: number = 10): number[] {
  if (data.length === 0) {
    return []
  }
 ...
 */
export function calculateEMADifference(data: number[], fastLength: number, slowLength: number): number[] {
