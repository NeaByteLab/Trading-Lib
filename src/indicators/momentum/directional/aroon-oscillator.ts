...
export class AroonOscillator extends BaseIndicator {
  ...
  private calculateAroonOscillator(data: number[], length: number): number[] {
 ...
 */
export function aroonOscillator(data: MarketData | number[], length?: number, source?: string): number[] {
