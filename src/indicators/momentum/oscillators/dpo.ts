...
export class DPO extends BaseIndicator {
  ...
  private calculateDPO(data: MarketData | number[], length: number): IndicatorResult {
 ...
 * @returns DPO values
 */
export function dpo(data: MarketData | number[], length?: number, source?: string): number[] {
