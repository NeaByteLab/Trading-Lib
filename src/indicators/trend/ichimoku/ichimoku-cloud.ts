 ...
 */
function calculateIchimoku(data: MarketData, tenkanPeriod: number, kijunPeriod: number, senkouBPeriod: number, displacement: number): {
  tenkan: number[]
  kijun: number[]
  senkouA: number[]
  senkouB: number[]
 ...
 */
function calculateMidpoint(high: number[], low: number[], period: number): number[] {
 ...
 */
function calculateSenkouA(tenkan: number[], kijun: number[], displacement: number): number[] {
