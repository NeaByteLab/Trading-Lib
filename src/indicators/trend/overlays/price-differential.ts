 ...
 * ```
 */
export function priceDifferential(price1: number[], price2: number[]): number[] {
 ...
 */
export const PriceDifferentialIndicator = createPriceComparisonIndicator(
  'Price Differential',
  'Calculates the difference between two price series',
  calculatePriceDifferential
)
