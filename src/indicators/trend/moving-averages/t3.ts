 ...
 */
function calculateT3(data: number[], length: number = 20, a: number = 0.7): number[] {
...
export class T3 extends BaseIndicator {
  ...
  calculate(data: MarketData | number[], config?: IndicatorConfig): IndicatorResult {
    ...
    const a = (config?.['a'] as number) || 0.7
 ...
 * @returns T3 values array
 */
export function t3(data: MarketData | number[], length?: number, a?: number, source?: string): number[] {
