 ...
 */
function calculateTwiggsMoneyFlowWrapper(data: MarketData | number[], length: number = 21): number[] {
 ...
 * ```
 */
export function twiggsMoneyFlow(data: MarketData, length?: number): number[] {
