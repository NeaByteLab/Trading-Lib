 ...
 */
function calculateVWMAIndicator(data: MarketData | number[], length: number = 20): number[] {
 ...
 * @returns VWMA values array
 */
export function vwma(data: MarketData | number[], length?: number, source?: string): number[] {
