...
import {
  ...
  validateMarketDataOnly,
  validateNumberArrayOnly,
  pineSource,
  pineLength,
  pineOffset,
  createIndicatorResult,
  validateOHLCData,
  validateVolumeDataForIndicators,
  createMultiResultIndicatorWrapper
} from '@utils/index'
...
describe('Utils Module - Final Tests', () => {
  ...
  describe('ArrayUtils', () => {
    ...
    it('should validate array', () => {
      ...
      expect(() => ArrayUtils.validateArray(null as any, 1)).toThrow()
    })
  ...
  describe('Validation Utils', () => {
    it('should validate array', () => {
      ...
      expect(() => validateArray(null as any, 1)).toThrow()
    })
    ...
    it('should validate indicator data', () => {
      ...
      expect(() => validateIndicatorData(null as any)).toThrow()
    })
  ...
  describe('Indicator Utils', () => {
    ...
    it('should create multi-result indicator wrapper', () => {
      ...
      const result = createMultiResultIndicatorWrapper(MockIndicator as any, testData, 14)
      expect(result).toHaveProperty('values')
